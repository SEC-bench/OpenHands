...
def get_instruction(instance: pd.Series, metadata: EvalMetadata):
    ...
    if task_type == 'poc':
        ...
        instruction = (
            ...
            f'<issue_description>\n'
            f'{extract_sanitizer_report(instance.bug_description)}\n'
            '</issue_description>\n\n'
...
# DOCKER_IMAGE_PREFIX = os.environ.get('EVAL_DOCKER_IMAGE_PREFIX', 'docker.io/hwiwonlee/')
